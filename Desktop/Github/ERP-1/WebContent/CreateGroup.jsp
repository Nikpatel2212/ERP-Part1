...
<jsp:include page="Include/Menu.jsp" ></jsp:include>
 <form action="creategroup" class="register" style="height:100%; width: 450px; scrolling:yes">
           ...
           <p></p><p></p> <h1> Create Group</h1>
            ...
            <fieldset class="row2" style="border-right: none; ">
                ...
                <p>
                    ...
                    <input type="hidden" required="required" name="own" value="<%=(String)session.getAttribute("username") %>" class="long"/>
                </p>
                <p>
                    <label>Description
                    </label>
