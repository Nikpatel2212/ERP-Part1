...
<%
 ...
 <form action="AdminEmployeeUpdate" style="height: 640px" class="register">
           
           <p></p><p></p> <h1> Employee Details</h1>
            <p></p><p></p>
            <fieldset class="row2">
            ...
            <fieldset class="row3">
                ...
                <p>
                    ...
                    <input type="text" required="required" name="jod" value="<%=rst.getString("jod")%>" class="long"/>
                </p>
                <p>
                    <label>Designation *
                    </label>
