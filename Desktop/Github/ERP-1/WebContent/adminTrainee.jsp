...
<%
 ...
 <form action="AdminTraineeUpdate" style="height: 650px" class="register">
           
           <p></p><p></p> <h1>Trainee Details</h1>
            <p></p><p></p>
            <fieldset class="row2">
            ...
            <fieldset class="row3">
                ...
                <p>
                    ...
                    <input type="text" readonly="readonly" required="required" name="jod" value="<%=rst.getString("jod")%>" class="long"/>
                </p>
                <p>
                    <label>Duration *
                    </label>
